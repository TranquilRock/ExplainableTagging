...
class SeqtoSeqDataset(Dataset):
    ...
    def _formulate_item(self, q, r, s, q_labels, r_labels, pid, rawq, rawr):
        ...
        if self.mode == "train":
            ...
            document_labels = self._pad_to_len(
                document_labels, self.document_max_length
            )
            ...
            return (
                pid,
                input_tokens,
                rawq[: self.query_max_length],
                rawr[: self.query_max_length],
            )
    ...
    def _preprocess(self, data: List[Dict]):
        ...
        for element in data:
            ...
            item = self._formulate_item(
                q, r, s, q_labels, r_labels, pid, element["q"], element["r"]
            )
